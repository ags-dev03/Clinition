...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (select) {
        ...
        if (!isSmall) {
            rowsCols.push(
                [10000, 100], [50000, defaultColCount], [100000, defaultColCount]
            );
        }
...
var countries = [
    { country: "Ireland", continent: "Europe", language: "200" },
    { country: "Spain", continent: "Europe", language: "200" },
    { country: "United Kingdom", continent: "Europe", language: "200" },
    { country: "France", continent: "Europe", language: "200" },
    { country: "Germany", continent: "Europe", language: "200" },
    { country: "Luxembourg", continent: "Europe", language: "200" },
    { country: "Sweden", continent: "Europe", language: "200" },
    { country: "Norway", continent: "Europe", language: "200" },
    { country: "Italy", continent: "Europe", language: "200" },
    { country: "Greece", continent: "Europe", language: "200" },
    { country: "Iceland", continent: "Europe", language: "200" },
    { country: "Portugal", continent: "Europe", language: "200" },
    { country: "Malta", continent: "Europe", language: "200" },
    { country: "Brazil", continent: "South America", language: "200" },
    { country: "Argentina", continent: "South America", language: "200" },
    { country: "Colombia", continent: "South America", language: "200" },
...
var firstNames = ["Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana",
    "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana",
    "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana", "Tatyana"
];
var lastNames = ["jhhjfd", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick",
    "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick",
    "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick",
    "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick",
    "Fitzpatrick", "Fitzpatrick", "Fitzpatrick", "Fitzpatrick"
];
...
function ratingRendererGeneral(value, forFilter) {
    ...
    for (var i = 0; i < 5; i++) {
        if (value > i) {
            result += '<img src="assets/images/star.svg" alt="' + value + ' stars" class="star" width="12" height="12" />';
        }
    }
